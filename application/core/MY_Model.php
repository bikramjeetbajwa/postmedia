...
class MY_Model extends CI_Model
{
    ...
    /**
     * Added By: Bikram Bajwa
     * Purpose: to handle Is Active functionality
     */
    protected $active_flag = FALSE;
    protected $active_flag_key = 'ACTIVE_FLAG';
    protected $_active_flag_value = 'Y';
    protected $_temporary_with_inactive = FALSE;

    /**
     * Added By: Bikram Bajwa
     * Purpose: to set error object
     */
    public $_error;
    ...
    public function __construct()
    {
        ...
        /*
         * Added By: Bikram Bajwa
         * Purpose: To set DB Context Variables
         * -----------------------------
         */
         setDbContextVariables();
    ...
    public function get_by()
    {
        ...
        if($this->active_flag && $this->_temporary_with_inactive !== TRUE){
            $this->_database->where($this->active_flag_key, $this->_active_flag_value);
        }
    ...
    public function insert($data, $skip_validation = FALSE)
    {
        ...
        if ($data !== FALSE)
        {
            ...
            //Comment By: Bikram Bajwa, Last Insert ID feature is not available in Oracle
            //--------------------------------------------------------
    ...
    function dropdown()
    {
        ...
        if($this->active_flag && $this->_temporary_with_deleted !== TRUE){
            $this->_database->where($this->active_flag_key, $this->_active_flag_value);
        }
     ...
     * Changed By   : Bikram Bajwa
     * Reason       : Oracle compatibility
     */
    public function get_next_id()
    {
        return (int) $this->_database->select('ORASEQ.NEXTVAL AS ID')->from('DUAL')->get()->row()->ID;
        /*
    ...
    public function get_sequence_num($seq_code = '')
    {
        if($seq_code != ''){
            return $this->_database->select('system_functions_pkg.get_seq_nextval(p_seq_code => \''.$seq_code.'\') as SEQ_NUM')->from('DUAL')->get()->row()->SEQ_NUM;
        }
        return false;
    }
    ...
    /**
     * Don't care about inactive rows on the next call
     */
    public function with_inactive()
    {
        $this->_temporary_with_inactive = TRUE;
        return $this;
    }

    /**
     * Only get inactive rows on the next call
     */
    public function only_inactive()
    {
        $this->_active_flag_value = 'N';
        return $this;
    }
